...
void matrixInverse(const Matrix m, Matrix a)
{
   ...
   a[1][0] = (m[1][2]*m[2][0] - m[1][0]*m[2][2])/det;
   ...
   a[1][2] = (m[0][2]*m[1][0] - m[0][0]*m[1][2])/det;
...
{
    Vector a1,a2,a3,b1,b2,b3,tmp;
    double dd,dd1,dd2,dd3,dd4;

    vectorSet(a1,m[0][0],m[0][1],m[0][2]);
    vectorSet(a2,m[1][0],m[1][1],m[1][2]);
    vectorSet(a3,m[2][0],m[2][1],m[2][2]);
    ...
    dd3 = dd3/dd1;
    dd4 = dd4/dd2;
    vectorScale(b1,dd3,tmp);
    vectorScale(b2,dd4,b3);
    vectorSub(a3,b3,b3);
    vectorSub(b3,tmp,b3);
...
//    a[0][0] = (m[1][1]*m[2][2] - m[1][2]*m[2][1])/det;
//    a[0][1] = (m[0][2]*m[2][1] - m[0][1]*m[2][2])/det;
//    a[1][1] = (m[0][1]*m[1][2] - m[0][2]*m[1][1])/det;
//    a[1][0] = (m[1][2]*m[2][0] - m[1][0]*m[2][2])/det;
//    a[1][1] = (m[0][0]*m[2][2] - m[0][2]*m[2][0])/det;
//    a[1][2] = (m[0][2]*m[1][0] - m[0][0]*m[1][2])/det;
//    a[2][0] = (m[1][0]*m[2][1] - m[1][1]*m[2][0])/det;
...
void matrixCopy(const Matrix m, Matrix a)
{
    a[0][0] = m[0][0];
    a[0][1] = m[0][1];
    a[0][2] = m[0][2];
...
void xyz2tpr(const Vector v1, Vector v)
{
    ...
    r = vectorDot(v1,v1);
	r = sqrt(r);
    rxy = sqrt(v1[0]*v1[0]+v1[1]*v1[1]);
    theta = atan2(rxy,v1[2]);
